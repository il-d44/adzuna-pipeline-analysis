...
if page == "Home":
    ...
    st.markdown(
        ...
        - **💻 Tech Trends** – See which programming languages & tools are in demand.
        - **💰 Salary Insights** – Understand salary distributions across locations.
        - **📄 Raw Data** – See the full dataset used in this analysis.
    ...
    with tab1:
        ...
        salary_by_location['salary_label'] = salary_by_location['salary_min_mean'].round(0).astype(int).apply(lambda x: f"£{x:,}")
        ...
        st.write("""
                ...
                Each green circle represents a location — the **size** of the circle is proportional to the average minimum salary.  
        ...
        hover_text = [
        f"<b>{loc}</b><br>Avg Min Salary: £{int(sal):,}<br>Job Listings: {int(count)}"
